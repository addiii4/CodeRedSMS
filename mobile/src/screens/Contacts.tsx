...
export default function Contacts() {
    ...
    return (
      <View style={styles.container}>
              ...
              {contacts
                ...
                .map((c) => (
                  <ListRow
                    ...
                    meta={c.phoneE164}
                    onPress={() =>
                      navigation.navigate('ContactDetail', { contact: c })
                    }
                  />
                ))}
              {/* 
        ...
        <BottomCTA
          label={tab === 'Groups' ? 'New Group' : 'Add Person'}
          onPress={() =>
            navigation.navigate(tab === 'Groups' ? 'GroupEdit' : 'PersonEdit')
          }
        />
